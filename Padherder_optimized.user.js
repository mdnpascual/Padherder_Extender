...
(function() {
  ...
  "649:::648", "781:::780", "188:::187", 3154, 3012, "825:::232:::105:::104", 2233, 1524, 1462, 785, "769:::768", 1245, 3086, 2550, 2399, "319:::85:::84", 1630, "214:::32:::31:::30", 809, 1219, "349:::348", 281, 836, "1062:::1061", 2736, 2525, "814:::813", 1846, "647:::646", "645:::644", 644, "683:::682", "190:::189", "188:::187", 3244, 3152, "2069:::2068", 2068, 544, 1464, 1247, 287, 813, 2401, "320:::87:::86", 1595, 770, 278], v = [], D, x, E, n = [], r, m, A = [], y = [], B = [], C = [], g = [],
  z;
  ...
  $.when(v[0], v[1]).done(function() {
    ...
    $.when(n[0], n[1], n[2], n[3]).done(function() {
              ...
              if (!H.includes(a)) {
                ...
                for (k = ""; e < x.length;) {
                  ...
                  for (p = 0; p < h.length - 1;) {
                    u = h[p];
                    w = I.indexOf(parseInt(m.substring(c + 1, d).split(",")[0]));
                    n = [];
                ...
                "" !== k && C.push(y[b][0].target_evolution + "(" + m.substring(c + 1, d).split(",")[1] + ")::: " + m.substring(c + 1, d).split(",")[0] + "::: " + k + "::: " + g[l(y[b][0].monster, g)].name + "::: " + y[b][1]);
              }
              c--;
            } else {
              "]" == a.charAt(0) && (d = c);
      ...
      for (b = 1; b < a.length;) {
        ...
        w = a[b][4].split(":::"), h += a[b][0] + '" target="_blank" tabindex="-1"><span class="tooltip2text">Found in today\'s Dungeons:', h += q(a[b][2].split(":::")).join("<br>").split("|||").join("<br>") + '</span><img src="http://pad.dnt7.com/', h += a[b][3] + '" alt="Mountain View" style="width:45px;height:45px;"></a></th> </tr> <tr> <td class="tg-0ord" colspan="2">', h += a[b][1] + "</td> </tr> ", a[b][7].includes("3") && (f = t(p, u, w, 3, "H")), a[b][7].includes("2") && (c = t(p, u, w, 2,
        "M")), a[b][7].includes("1") && (e = t(p, u, w, 1, "L")), a[b][7].includes("0") && (k = t(p, u, w, 0, "F")), d += h + (f + c + e + k) + "</table>", b++;
      }
      d += "<br><br>";
      b = 0;
      c = 1;
